...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        DecryptorT(const EncryptionParameters &parms, const BigPoly &secret_key);
        ...
        */
        ...
        void decryptMU(const BigPolyArray &encrypted, BigPoly &destination, BigPoly &decryptedSPU);
        /**
